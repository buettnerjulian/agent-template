...
infer: true
handoffs:
  - label: Request Advanced Testing
    agent: testing
    prompt: Create comprehensive API test suite
  - label: Request Documentation
    agent: documentation
    prompt: Document API endpoints and usage
  - label: Request Code Improvements
    agent: code
    prompt: Improve pre-request and test scripts
---
...
var signature = CryptoJS.HmacSHA256(timestamp.toString(), pm.environment.get("api_secret")).toString();
